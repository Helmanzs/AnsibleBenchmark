...
\begin{itemize}
    ...
    \cite{yamldocs}
    \begin{lstlisting}[language=YAML, caption={Ukázka stuktury YAML}, label={lst:yamlshowcase}, captionpos=b]
    general:
        name: TestApp
        version: 1.0
    ...
    \begin{lstlisting}[caption={Ukázka struktury INI}, label={lst:inishowcase}, captionpos=b]
    [General]
    name=TestApp
    version=1.0
...
Zdrojové kódy této bakalářské práce jsou umístěny ve veřejném repozitáři na adrese:\\ \url{https://github.com/Helmanzs/AnsibleBenchmark}.

\begin{longtable}{ll}
\hline
Project/ & zdrojový kód praktické části \\
Thesis/ & zdrojový kód psané části \\
zaverecna\_prace.pdf & Bakalářská práce v PDF \\
README.md & Návod na instalaci a spuštění benchmarku \\
\hline
\end{longtable}