...
Pro účely testování bylo pomocí nástroje Ansible vytvořeno automatizované a~reprodukovatelné testovací prostředí s~monitoringem přes Prometheus a~Grafanu. 
...
An automated and reproducible testing environment was built with Ansible, with monitoring handled by Prometheus and Grafana. 
